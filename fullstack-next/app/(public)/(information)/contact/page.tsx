...
export default function Contact() {
  ...
  function onSubmit({ firstName, lastName, email, message }: any) {
    ...
    <main className="grow px-5 bg-information-background bg-cover bg-center flex justify-center sm:items-center">
      ...
      >
        ...
        <p className="mb-6 text-center">
          If you have any questions or comments about our website, feel free to
          fill in this form. We'd love to hear from you.
        </p>
        <label
          htmlFor="firstName"
        ...
        <div className="w-full flex justify-center">
          <button
            type="submit"
            className="px-3 py-2 mt-4 sm:mt-7 bg-gray-100 rounded-sm border border-gray-300 hover:bg-gray-200"
          >
            Submit
          </button>
        </div>

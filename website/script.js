...
const newsImages = [
  "/images/news-images/John_Sharon_Official_1.jpg",
...
const popularImages = [
  "/images/popular/Elegant_colours_of_Navratri.jpg",
...
const saleImages = [
  "/images/sale/5550676712_bdfe1c4506_b.jpg",
...
const inspirationImages = [
  "/images/inspiration/adult_autumn_casual_clothes_colors_fall_fashion_fine_looking-1514707-133368789.jpeg",
...
async function fetchLatestProductsFromAPI() {
  try {
    ...
    for (var i = 0; i < 4; i++) {
      ...
      const productDescriptionElement = document.querySelectorAll(
        ".product-description"
      )[i];

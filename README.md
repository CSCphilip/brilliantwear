...
- [ ] Log in functionality for admins to, for instance, upload new products. Add logout button. Implement a dashboard for admins. **Edit**: Now when logged in, an admin is able to look at the dashboard, see all of the users in the MongoDB, add & edit & delete users.
